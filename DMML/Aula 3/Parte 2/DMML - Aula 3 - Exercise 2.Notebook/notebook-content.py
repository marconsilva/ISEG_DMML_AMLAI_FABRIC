...
click_data = pd.read_csv('/lakehouse/default/Files/DMML_Aula3/feature-engineering-data/train_sample.csv',
...
#
# **Note**: If you're not familiar with one-hot encoding, please check out aula 3.
#
