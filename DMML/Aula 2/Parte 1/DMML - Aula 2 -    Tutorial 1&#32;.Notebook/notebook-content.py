...
# 
# In this lesson, you'll learn how to take your data visualizations to the next level with [seaborn](https://seaborn.pydata.org/index.html), a powerful but easy-to-use data visualization tool.  To use seaborn, you'll also learn a bit more about how to write code in Python  That said, each chart uses short and simple code, making seaborn much faster and easier to use than many other data visualization tools (_such as Excel, for instance_).  
# 
# 
...
# 
# We refer to these pages as **Fabric notebooks** , and we'll work with them throughout the class.  Another example of a notebook can be found in the image below.  
# 
...
fifa_filepath = "/lakehouse/default/Files/DMML_Aula2/fifa.csv"
...
# # What's next?
# 
# Write your first lines of code in the **[first coding exercise]** notebook!
