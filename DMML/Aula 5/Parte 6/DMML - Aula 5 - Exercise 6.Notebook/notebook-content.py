...
# Load the data
train_data = pd.read_csv('/lakehouse/default/Files/DMML_Aula5/home-data-for-ml-course/train.csv')
test_data  = pd.read_csv('/lakehouse/default/Files/DMML_Aula5/home-data-for-ml-course/test.csv')
