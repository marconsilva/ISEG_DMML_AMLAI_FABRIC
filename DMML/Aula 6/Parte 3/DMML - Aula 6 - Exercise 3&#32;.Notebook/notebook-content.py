...
# Read the data
X = pd.read_csv('/lakehouse/default/Files/DMML_Aula6/home-data-for-ml-course/train.csv', index_col='Id')
X_test_full = pd.read_csv('/lakehouse/default/Files/DMML_Aula6/home-data-for-ml-course/test.csv', index_col='Id')
