...
dataset_train = pd.read_csv('/lakehouse/default/Files/AMLAI_Aula5/Google_Stock_Price_Train.csv')
...
dataset_test = pd.read_csv('/lakehouse/default/Files/AMLAI_Aula5/Google_Stock_Price_Test.csv')
dataset_test.head()
