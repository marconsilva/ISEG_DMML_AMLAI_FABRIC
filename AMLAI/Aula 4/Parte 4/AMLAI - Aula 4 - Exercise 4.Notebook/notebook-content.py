...
image_dir = os.path.join(DATA_ROOT, 'AMLAI_Aula4', 'computer-vision-resources', '')
...
machinelearning = pd.read_csv(
    os.path.join(
        DATA_ROOT, 'AMLAI_Aula4', 'computer-vision-resources',
        'machinelearning.csv'
    ),
    parse_dates=['Week'],
    index_col='Week',
...
# # Keep Going #
# 
# In the next lesson, you'll learn how to compose the `Conv2D` and `MaxPool2D` layers to build your own convolutional networks from scratch.
