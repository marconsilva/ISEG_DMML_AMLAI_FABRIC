...
# 
# We train a model by choosing weights or parameters that minimize the loss on a training set. You might know, however, that to accurately assess a model's performance, we need to evaluate it on a new set of data, the *validation* data. (Recall Validation module from DMML.)
# 
...
red_wine = pd.read_csv(os.path.join(DATA_ROOT, 'AMLAI_Aula4', 'red-wine.csv'))
